...
export const productFeedbacks: ProductFeedbackType[] = [
  {
    id: 1,
...
export const productFeedbackFiltredBySuggestionStatus = productFeedbacks.filter(
  (suggestion: ProductFeedbackType) => {
    return suggestion.status === 'suggestion'
  }
)

export const productFeedbackFiltredBySuggestionStatusSortedByScore = [
